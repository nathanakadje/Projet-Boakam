...
<!-- Modal Pour le formulaire -->
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <!-- Slide Img -->
                <div class="slide-img bg-img" style="background-image: url(./accueil/img/bg-img/bg-1.jpg);"></div>
                <div class="container">
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <!-- Slide Img -->
                <div class="slide-img bg-img" style="background-image: url(./accueil/img/bg-img/bg-2.jpg);"></div>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-9">
                            <!-- Slide Content -->
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <!-- Slide Img -->
                <div class="slide-img bg-img" style="background-image: url(./accueil/img/bg-img/bg-3.jpg);"></div>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-9">
                            <!-- Slide Content -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail homepage mb-100">
                        ...
                        <div class="first-img wow fadeInUp" data-wow-delay="100ms">
                            <img src="./accueil/img/bg-img/5.jpg" alt="">
                        </div>
                        <!-- Second Img -->
                        <div class="second-img wow fadeInUp" data-wow-delay="300ms">
                            <img src="./accueil/img/bg-img/6.jpg" alt="">
                        </div>
                        <!-- Third Img-->
                        <div class="third-img wow fadeInUp" data-wow-delay="500ms">
                            <img src="./accueil/img/bg-img/7.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- ##### Pool Area Start ##### -->
    <section class="pool-area section-padding-100 bg-img bg-fixed" style="background-image: url(./accueil/img/bg-img/4.png);">
        <div class="container">
