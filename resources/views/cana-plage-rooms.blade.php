      ...
      @endif
                <form id="reservationForm" action="{{ route('stores.store') }}" method="POST" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Nom et Prénom" maxlength="25"name="name" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="phone" placeholder=" Contact Ex: 07xxxxxxxx" maxlength="25" name="phone" >
                        <div class="invalid-feedback"></div>
                    </div>
                    {{-- <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="montant" class="form-label" style="width: 100%;">Montant de la chambre :</label>
                            <input type="number" class="form-control" id="montant" name="montant" maxlength="5" min="20000" step="5000" max="50000" placeholder="disponible: 20.000, 25.000, 30.000, 50.000">
                        <div class="invalid-feedback"></div>
                    </div>
